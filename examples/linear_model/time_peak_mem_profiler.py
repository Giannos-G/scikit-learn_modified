...
filename = "plot_tweedie_regression_insurance_claims.py"
################# Memory profiling #################

print ("...Memory Profiling...")
os.system('mprof run --python --interval 0.01 --output memory_profiling.txt plot_tweedie_regression_insurance_claims.py')
