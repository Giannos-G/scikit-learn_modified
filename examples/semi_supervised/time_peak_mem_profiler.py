...
filename = "plot_semi_supervised_versus_svm_iris.py"
################# Memory profiling #################

print ("...Memory Profiling...")
os.system('mprof run --python --interval 0.01 --output memory_profiling.txt plot_semi_supervised_versus_svm_iris.py')
