...
import plot_compare_calibration
...
filename = "plot_compare_calibration.py"
################# Memory profiling #################

print ("...Memory Profiling...")
os.system('mprof run --python --interval 0.01 --output memory_profiling.txt plot_compare_calibration.py')
