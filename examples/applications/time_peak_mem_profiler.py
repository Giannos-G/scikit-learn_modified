...
import plot_topics_extraction_with_nmf_lda
...
filename = "plot_topics_extraction_with_nmf_lda.py"
################# Memory profiling #################

print ("...Memory Profiling...")
os.system('mprof run --python --interval 0.01 --output memory_profiling.txt plot_topics_extraction_with_nmf_lda.py')
