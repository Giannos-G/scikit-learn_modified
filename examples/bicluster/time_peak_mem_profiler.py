...
import plot_spectral_coclustering 
...
filename = "plot_spectral_coclustering.py"
################# Memory profiling #################

print ("...Memory Profiling...")
os.system('mprof run --python --interval 0.01 --output memory_profiling.txt plot_spectral_coclustering.py')
